...
function getDowngradeChance() {
	...
	enchantData.forEach(function (item) {
		...
		if (enchantId == enchantment) {
			...
			downgradeChance = upgradeFailChance * ENCHANT_UPGRADE_SETTINGS.downgradeChance[enchantLevel]
		}
	})

	return Math.floor(downgradeChance) + ''
}
