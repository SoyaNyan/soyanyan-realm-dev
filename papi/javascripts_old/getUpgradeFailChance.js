...
function getUpgradeFailChance() {
	...
	enchantData.forEach(function (item) {
		...
		if (enchantId == enchantment) {
			...
			var downgradeChance =
				upgradeFailChance * ENCHANT_UPGRADE_SETTINGS.downgradeChance[enchantLevel]
			netUpgradeFailChance = upgradeFailChance - downgradeChance
		}
	})
